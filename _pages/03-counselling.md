...
<img src="{{ "/images/TherapyRoomSmall-400.png" | absolute_url }}" class="left fit" /> I offer an initial appointment from premises on Abbeydale Road, Sheffield, with subsequent sessions from premises in the S11 area of Sheffield. In both cases access is up one flight of stairs.
